...
\TextField{Full Name:} \break
\TextField{E-mail:} \break
\TextField[multiline=true,width=3in,height=1in]{Postal Address:} \break
\TextField{Telephone Number:} \break
\TextField{Fax Number:} \break
Signature:\sigField[\Lock{/Action/All}]{signature}{5cm}{3cm}
\break \break
